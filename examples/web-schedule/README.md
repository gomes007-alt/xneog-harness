...
This overlay opts one `xneog web` process into Schedule reminders without changing the shipped default Web composition:

```sh
xneog web --patch examples/web-schedule/cordis.yml
```
