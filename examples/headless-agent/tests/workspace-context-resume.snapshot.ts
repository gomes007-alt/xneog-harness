...
import { normalizeSessionLog, scrubRequestHeaders, type NormalizeContext } from '@xneog/dsh-acp-snapshot'
...
import { renderWorkspaceContext } from '@xneog/dsh-agent-instructions'
import { resolveConfig, workspaceBaselineIdentity } from '@xneog/dsh-agent-instructions/src/config.ts'
