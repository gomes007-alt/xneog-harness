...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@xneog/dsh-agent-loop`.
- No cross-package deep imports (`@xneog/dsh-*/src/...` paths) — public entry points only.
