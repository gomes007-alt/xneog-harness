...
| --- | --- | --- | --- |
| `@xneog/dsh-storage` | `packages/storage/storage/` | `ctx.storage` (the hub) | ✓ |
| `@xneog/dsh-storage-json` | `packages/storage/storage-json/` | registers backend `json` | ✓ |
| `@xneog/dsh-storage-sqlite` | `packages/storage/storage-sqlite/` | registers backend `sqlite` | ✓ |
| `@xneog/dsh-storage-domain` | `packages/storage/storage-domain/` | mounts `ctx.storage.domain` | ✓ |
| `@xneog/dsh-workspace` | `packages/workspace/workspace/` | `ctx.workspaceRegistry` | ✓ |
