/** JSON string-prefix accounting for the outer-output ledger. @module @xneog/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@xneog/dsh-code-runtime'
