/**
 * Package-owned invariant companion for `@xneog/dsh-code-runtime-worker-thread`.
 * @module @xneog/dsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-code-runtime-worker-thread'
