 ...
 *
 * @module @xneog/dsh-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@xneog/node-addon-landlock-run'
 ...
 * (`@xneog/dsh-fs-sandbox`) can never drift apart.
