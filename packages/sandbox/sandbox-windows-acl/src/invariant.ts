/**
 * Package-owned invariant companion for `@xneog/dsh-sandbox-windows-acl`.
 * @module @xneog/dsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-sandbox-windows-acl'
