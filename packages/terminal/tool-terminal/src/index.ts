 ...
 * @module @xneog/dsh-tool-terminal
 */
...
import { TerminalSessionId } from '@xneog/dsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@xneog/dsh-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @xneog/dsh-jobs and @xneog/dsh-tool-jobs')
