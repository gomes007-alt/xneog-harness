/**
 * @xneog/dsh-headless — one-shot direct Agent driver. The bundle patch
...
import type { ModelSelectionRef } from '@xneog/dsh-agent'
import type {} from '@xneog/dsh-agent-default-model'
...
import type {} from '@xneog/dsh-cmdline'
