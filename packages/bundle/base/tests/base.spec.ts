...
describe('dsh-base bundle', () => {
  it('declares a parseable patch list through the dsh.bundle.patch manifest field', () => {
    ...
    expect(manifest.dependencies).not.toHaveProperty('@xneog/dsh-subagent-codex')
    expect(manifest.dependencies).not.toHaveProperty('@xneog/dsh-subagent-claude-code')
  })
