/** Package-owned invariant companion for `@xneog/dsh-attachment-local`. @module @xneog/dsh-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@xneog/cordis'
import type { InvariantInstaller } from '@xneog/dsh-invariants'

const PACKAGE_NAME = '@xneog/dsh-attachment-local'
