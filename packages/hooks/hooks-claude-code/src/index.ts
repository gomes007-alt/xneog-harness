 ...
 * @module @xneog/dsh-hooks-claude-code
 */
...
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@xneog/dsh-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
