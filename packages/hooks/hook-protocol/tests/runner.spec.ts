...
import type { ShellExecRequest, ShellExecSpec, ShellExecutor, ShellRunResult } from '@xneog/dsh-shell'
import { DEFAULT_HOOK_TIMEOUT_MS, runHook } from '@xneog/dsh-hook-protocol'
import type { RunHookOptions } from '@xneog/dsh-hook-protocol'
