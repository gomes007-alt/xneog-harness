/** Package-owned goal-round prompt invariants. @module @xneog/dsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@xneog/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@xneog/dsh-goal'
import type { InvariantFailure, InvariantInstaller } from '@xneog/dsh-invariants'
import type { Session, SessionEvent } from '@xneog/dsh-session'
import { renderGoalRoundPrompt } from './prompt.ts'

const PACKAGE_NAME = '@xneog/dsh-goal-round-driver'
