...
import * as GoalSessionInvariant from '@xneog/dsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@xneog/dsh-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@xneog/dsh-invariants'
import SessionStore, { SessionId, type Session } from '@xneog/dsh-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@xneog/dsh-goal-round-driver',
    }))
  })
