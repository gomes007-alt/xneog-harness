...
import { createUserMessage, HarnessError } from '@xneog/dsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@xneog/dsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
...
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@xneog/dsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@xneog/dsh-session').SessionEvent[]): StubAgent {
