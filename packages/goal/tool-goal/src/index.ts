 ...
 * @module @xneog/dsh-tool-goal
 */

import type { Context } from '@xneog/cordis'
import z from '@xneog/schemastery'
import { GoalId } from '@xneog/dsh-goal'
import type { GoalRef, GoalView } from '@xneog/dsh-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@xneog/dsh-llm'
import { defineTool } from '@xneog/dsh-tools'
import type { GenericCallView } from '@xneog/dsh-tools'
