/**
 * Package-owned invariant companion for `@xneog/dsh-tool-session-query`.
 * @module @xneog/dsh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-tool-session-query'
