/**
 * Package-owned invariant companion for `@xneog/dsh-session-query-sqlite`.
 * @module @xneog/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-query-sqlite'
