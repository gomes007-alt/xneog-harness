import { createAssistantMessage, createUserMessage } from '@xneog/dsh-llm'
import { afterEach, describe, expect, it, vi } from 'vitest'
import { Context, type Fiber } from '@xneog/cordis'
import { DatabaseSync } from 'node:sqlite'
import { chmod, mkdtemp, rm, stat, writeFile } from 'node:fs/promises'
import { tmpdir } from 'node:os'
import { dirname, join } from 'node:path'
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from '@xneog/dsh-session'
import type { SessionEvent, SessionHeader, SessionId as SessionIdType } from '@xneog/dsh-session'
import SessionPersistence, { SessionPersistenceRevision } from '@xneog/dsh-session-persistence'
import type { SessionPersistenceSnapshot } from '@xneog/dsh-session-persistence'
import SqliteSessionPersistence from '@xneog/dsh-session-persistence-sqlite'
import SqliteSessionQueryEngine, {
  SESSION_QUERY_SQLITE_SCHEMA_VERSION,
} from '@xneog/dsh-session-query-sqlite'
import {
