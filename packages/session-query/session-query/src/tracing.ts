...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@xneog/dsh-session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@xneog/dsh-session'
