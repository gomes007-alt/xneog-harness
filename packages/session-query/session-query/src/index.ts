 ...
 *
 * @module @xneog/dsh-session-query
 */

import { Context, Service } from '@xneog/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@xneog/dsh-session'
import { foldSessionTitle } from '@xneog/dsh-session-title'
import type { SessionTitleSnapshot } from '@xneog/dsh-session-title'
import type {
