/**
 * Package-owned invariant companion for `@xneog/dsh-web-search-deepseek`.
 * @module @xneog/dsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-web-search-deepseek'
