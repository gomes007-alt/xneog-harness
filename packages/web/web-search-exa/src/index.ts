/**
 * `@xneog/dsh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@xneog/dsh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@xneog/dsh-web`.
 *
 * @module @xneog/dsh-web-search-exa
 */
...
import type {} from '@xneog/dsh-web'
import {
  ExaSearchProvider,
