...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@xneog/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@xneog/dsh-web'
 ...
 * `@xneog/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@xneog/dsh-tool-call-timeout-policy` to enforce.
