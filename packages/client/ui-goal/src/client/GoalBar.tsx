...
import type { GoalSnapshot } from '@xneog/dsh-goal/client'
import {
...
import type { PropsLocale } from '@xneog/dsh-client-ui-slots'
...
export type GoalDockProps = import('@xneog/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
