...
import { ConversationNodeAssembler } from '@xneog/dsh-client-runtime/client'
...
import type { SessionEvent } from '@xneog/dsh-session/types'
import { commandDefinition } from '@xneog/dsh-client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@xneog/dsh-client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
