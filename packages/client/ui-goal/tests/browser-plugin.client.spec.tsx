...
import { SlotRegistry, type SessionId } from '@xneog/dsh-client-runtime/client'
import { ConversationEventRegistry } from '@xneog/dsh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@xneog/dsh-goal/client'
