/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-attachment`.
 * @module @xneog/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-attachment'
