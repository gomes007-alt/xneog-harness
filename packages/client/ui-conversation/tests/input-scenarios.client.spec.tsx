...
import { InputTriggerService } from '@xneog/dsh-client-ui-input-trigger/client'
import type { ClientSessionContext, CommandClaim, PickOutcome, SubmitOutcome } from '@xneog/dsh-client-ui-input-trigger/client'
...
import { createSnapshotStore } from '@xneog/dsh-client-runtime/client'
import type { ConversationSnapshot } from '@xneog/dsh-client-runtime/client'
