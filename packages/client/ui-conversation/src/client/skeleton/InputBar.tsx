...
} from '@xneog/dsh-client-ui-primitives'
import { AttachmentRail, DropOverlay, ImageLightbox } from '@xneog/dsh-client-ui-attachment'
import type { AttachmentRailItem } from '@xneog/dsh-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@xneog/dsh-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@xneog/dsh-goal/client'
...
import type { Translate } from '@xneog/dsh-client-ui-slots'
