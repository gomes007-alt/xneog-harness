 ...
 * atoms' label props (`@xneog/dsh-client-ui-attachment` reads no
...
} from '@xneog/dsh-client-ui-attachment'
import type { ImageAttachmentLimits } from '@xneog/dsh-attachment'
