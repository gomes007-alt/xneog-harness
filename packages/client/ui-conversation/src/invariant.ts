/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-conversation`.
 * @module @xneog/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-conversation'
