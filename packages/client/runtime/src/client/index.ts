...
import type { ConnectionHandle, SessionId } from '@xneog/dsh-api-remotes/client'
...
import type { TypertContext } from '@xneog/dsh-typert-protocol'
import type { MaybeSnapshotSelectorHook, SnapshotSelectorHook } from '@xneog/dsh-client-ui-slots'
...
export { isAppendSurfaceEvent, isReplacementSurfaceEvent } from '@xneog/dsh-session/surface'
...
export type { SubagentAddress, JobView } from '@xneog/dsh-client-connection/client'
...
export type { SessionId } from '@xneog/dsh-client-connection/client'
...
declare module '@xneog/dsh-client-ui-slots' {
  /**
