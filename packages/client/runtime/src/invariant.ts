/**
 * Package-owned invariant companion for `@xneog/dsh-client-runtime`.
 * @module @xneog/dsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@xneog/dsh-client-ui-slots'
import type { InvariantInstaller } from '@xneog/dsh-invariants'

const PACKAGE_NAME = '@xneog/dsh-client-runtime'
