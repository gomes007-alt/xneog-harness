/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-agent-preset`.
 * @module @xneog/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-agent-preset'
