/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-model-selection`.
 * @module @xneog/dsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-model-selection'
