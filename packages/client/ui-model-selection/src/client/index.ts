...
import type { ModelSelection, SessionModels } from '@xneog/dsh-api-remotes/client'
import type { ClientContext } from '@xneog/dsh-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@xneog/dsh-client-ui-commands/client'
// Type-only: pulls the ui-conversation SlotMap merge (the input.model seat).
import type {} from '@xneog/dsh-client-ui-conversation/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@xneog/dsh-client-locale/client'
import type { TranslateNS } from '@xneog/dsh-client-ui-slots'
