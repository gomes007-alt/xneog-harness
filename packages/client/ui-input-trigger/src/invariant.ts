/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-input-trigger`.
 * @module @xneog/dsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-input-trigger'
