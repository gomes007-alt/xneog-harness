...
import { usePinnedBrowserLanguages } from '@xneog/dsh-client-test-runtime'
import { createScope, scopeOf, SlotRegistry } from '@xneog/dsh-client-runtime/client'
import type { SessionId } from '@xneog/dsh-client-runtime/client'
import { apply, inject, InputTriggerService } from '@xneog/dsh-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@xneog/dsh-client-ui-input-trigger/client'
