/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-trajectory`.
 * @module @xneog/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-trajectory'
