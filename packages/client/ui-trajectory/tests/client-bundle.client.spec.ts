 ...
 * not built (`pnpm --filter @xneog/dsh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@xneog/dsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@xneog/dsh-client-runtime/client', await import('@xneog/dsh-client-runtime/client')],
      ['@xneog/dsh-client-ui-primitives', await import('@xneog/dsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@xneog/dsh-client-locale/client')
