...
import { bindSnapshotSelector } from '@xneog/dsh-client-web-react'
import { resolveSlotLabel } from '@xneog/dsh-client-ui-slots'
import {
  ConversationEventRegistry, ConversationViewRegistry, createSnapshotStore,
  EMPTY_CHAT_SNAPSHOT,
} from '@xneog/dsh-client-runtime/client'
import { SlotRegistry } from '@xneog/dsh-client-runtime/client'
import type {
  ConversationSnapshot, RequestView,
  SessionId, SessionListState, SnapshotStore, WorkspaceListState,
} from '@xneog/dsh-client-runtime/client'
import type { ConvViewProps, ViewTab } from '@xneog/dsh-client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@xneog/dsh-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@xneog/dsh-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@xneog/dsh-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@xneog/dsh-client-locale/client'
import { stubSettingsScope } from '@xneog/dsh-client-test-runtime'
import type { LocaleKeysOf } from '@xneog/dsh-client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@xneog/dsh-client-ui-trajectory/client'
import { apply as nodeApply } from '@xneog/dsh-client-ui-trajectory'
