/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-deliverables`.
 * @module @xneog/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-deliverables'
