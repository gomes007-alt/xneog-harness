...
import type { ChatFileMentions, TurnTailOwnerProps } from '@xneog/dsh-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@xneog/dsh-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@xneog/dsh-client-ui-deliverables'])
