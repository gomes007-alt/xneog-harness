...
import { apply, inject, SETTINGS_NS } from '@xneog/dsh-client-ui-theme/client'
import type { AppearanceRowInjected, ThemeRuntime } from '@xneog/dsh-client-ui-theme/client'
