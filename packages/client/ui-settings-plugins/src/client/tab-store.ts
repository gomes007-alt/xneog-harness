...
import type { IApiClient } from '@xneog/dsh-client-connection/client'
import type { StoredEntry } from '@xneog/dsh-client-ui-slots'
import { createSnapshotStore, type SnapshotStore } from '@xneog/dsh-client-runtime/client'
