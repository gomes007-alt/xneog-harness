/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-settings-plugins`.
 * @module @xneog/dsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-settings-plugins'
