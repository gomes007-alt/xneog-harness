...
import { TestRemote, usePinnedBrowserLanguages } from '@xneog/dsh-client-test-runtime'
import { SettingsScopeBinder } from '@xneog/dsh-client-ui-settings/client'
import { apply, inject } from '@xneog/dsh-client-ui-settings-plugins/client'
import type {
  ConfigurablePluginsTabFace, PluginsSettingsSectionInjected,
} from '@xneog/dsh-client-ui-settings-plugins/client'
