/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-commands`.
 * @module @xneog/dsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-commands'
