 ...
 * @module @xneog/dsh-client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@xneog/dsh-typert-protocol'
import type { HostObservable } from '@xneog/dsh-client-ui-slots'
import type { MessageId, SessionId } from '@xneog/dsh-client-connection/client'
import type {
...
} from '@xneog/dsh-message-feedback/types'
