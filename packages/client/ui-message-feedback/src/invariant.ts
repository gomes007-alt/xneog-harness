/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-message-feedback`.
 * @module @xneog/dsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-message-feedback'
