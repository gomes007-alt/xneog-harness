/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-settings-general`.
 * @module @xneog/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-settings-general'
