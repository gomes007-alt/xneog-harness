...
import type { SessionProviderComponent, TranslateNS } from '@xneog/dsh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@xneog/dsh-client-ui-conversation/src/client/contract/slots.ts'
