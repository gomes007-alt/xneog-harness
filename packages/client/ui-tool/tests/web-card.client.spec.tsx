...
import type { ToolResultView } from '@xneog/dsh-api-remotes/client'
import { bindSnapshotSelector } from '@xneog/dsh-client-web-react'
import type { SelectionTarget } from '@xneog/dsh-client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@xneog/dsh-client-ui-tool/client'
import { IconGlobeOutline14 } from '@xneog/dsh-client-ui-primitives'
...
import { DetailsPanel } from '@xneog/dsh-client-ui-conversation/src/client/skeleton/DetailsPanel.tsx'
import { WebRow, webToolview } from '../src/client/tool/toolviews/web-row.tsx'
import { renderToolDetails, SessionProviderStub, toolChatSnapshot } from './tool-details-render.client.tsx'
import { makeTranslate } from '@xneog/dsh-client-test-runtime'
import { zh as commonZh } from '@xneog/dsh-client-locale/src/locales/zh.ts'
import { zh } from '@xneog/dsh-client-ui-conversation/src/client/locales.ts'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@xneog/cordis').Context
