/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-settings-models`.
 * @module @xneog/dsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-settings-models'
