/**
 * Package-owned invariant companion for `@xneog/dsh-client-schema-form`.
 * @module @xneog/dsh-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-schema-form'
