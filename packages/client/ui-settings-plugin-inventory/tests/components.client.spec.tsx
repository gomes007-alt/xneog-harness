...
const SNAPSHOT = {
  entries: [
    { entryId: '8a1b2c3d', moduleName: '@xneog/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
    ...
    { entryId: 'disabled-entry', moduleName: '@xneog/dsh-host-directory-picker-native', enabled: false, fiberPhase: null },
  ],
