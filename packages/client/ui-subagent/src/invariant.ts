/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-subagent`.
 * @module @xneog/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-subagent'
