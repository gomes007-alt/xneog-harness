...
import type { ComposerChainProps } from '@xneog/dsh-client-ui-conversation/client'
import { InputTriggerService } from '@xneog/dsh-client-ui-input-trigger/client'
import type { ClientSessionContext, InputTriggerSource } from '@xneog/dsh-client-ui-input-trigger/client'
import { apply as applyLocale, inject as localeInject } from '@xneog/dsh-client-locale/client'
import {
