/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-permission-presets`.
 * @module @xneog/dsh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-permission-presets'
