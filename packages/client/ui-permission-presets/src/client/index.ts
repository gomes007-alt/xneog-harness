 ...
 */
import type { ConnectionHandle } from '@xneog/dsh-api-remotes/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@xneog/dsh-client-locale/client'
// Type-only: the settings slot types (this package registers a General row).
import type {} from '@xneog/dsh-client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@xneog/dsh-api-remotes/client'
import type { ClientContext, SessionFace } from '@xneog/dsh-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@xneog/dsh-client-ui-commands/client'
import type { ClientSessionContext } from '@xneog/dsh-client-ui-input-trigger/client'
import type { PermissionSelect } from '@xneog/dsh-permission-presets/client'
