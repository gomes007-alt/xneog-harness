/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-settings`.
 * @module @xneog/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-settings'
