/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-directory-picker-native`.
 * @module @xneog/dsh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-directory-picker-native'
