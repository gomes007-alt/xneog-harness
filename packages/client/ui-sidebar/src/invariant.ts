/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-sidebar`.
 * @module @xneog/dsh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-sidebar'
