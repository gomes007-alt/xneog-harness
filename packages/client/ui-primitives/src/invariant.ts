/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-primitives`.
 * @module @xneog/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-primitives'
