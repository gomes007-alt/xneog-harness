...
import type { DirectoryEntry, DirectoryListing } from '@xneog/dsh-client-runtime/client'
import { DirectoryBrowseError } from '@xneog/dsh-client-runtime/client'
import type { Translate } from '@xneog/dsh-client-locale/client'
