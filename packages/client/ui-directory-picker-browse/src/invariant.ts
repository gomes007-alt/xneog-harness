/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-directory-picker-browse`.
 * @module @xneog/dsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-directory-picker-browse'
