...
import { stubSettingsScope, type StubSettingsScope } from '@xneog/dsh-client-test-runtime'
import type { LocaleSettings, LocaleSnapshot } from '@xneog/dsh-client-locale/client'
