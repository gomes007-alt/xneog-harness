...
import { apply as nodeApply } from '@xneog/dsh-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@xneog/dsh-client-locale/client'
import * as LocaleInvariant from '@xneog/dsh-client-locale/invariant'
