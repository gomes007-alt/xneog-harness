 ...
 * that consumes it.
 */
import type { PropsLocale, PropsRuntime } from '@xneog/dsh-client-ui-slots'
...
import type { PendingWait } from '@xneog/dsh-client-runtime/client'
import type { QuestionResponsePayload } from '@xneog/dsh-api-remotes/client'
