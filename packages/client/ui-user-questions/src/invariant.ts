/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-user-questions`.
 * @module @xneog/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-user-questions'
