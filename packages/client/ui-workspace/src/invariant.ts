/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-workspace`.
 * @module @xneog/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-workspace'
