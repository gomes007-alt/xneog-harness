/**
 * Package-owned invariant companion for `@xneog/dsh-client-web-react`.
 * @module @xneog/dsh-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-web-react'
