/**
 * Package-owned invariant companion for `@xneog/dsh-client-ui-layout`.
 * @module @xneog/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-ui-layout'
