...
import { LocaleRuntime } from '@xneog/dsh-client-locale/client'
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@xneog/dsh-client-ui-theme/client'
import { apply, inject, LayoutController } from '@xneog/dsh-client-ui-layout/client'
import { apply as nodeApply } from '@xneog/dsh-client-ui-layout'
import * as invariant from '@xneog/dsh-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@xneog/dsh-client-ui-layout', expect.any(Function))
