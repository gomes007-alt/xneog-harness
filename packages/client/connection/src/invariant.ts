/**
 * Package-owned invariant companion for `@xneog/dsh-client-connection`.
 * @module @xneog/dsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-connection'
