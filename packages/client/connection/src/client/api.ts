...
export type {
  ...
  JobView,
} from '@xneog/dsh-host-apiproxy/api'
export type { ToolCallView, ToolResultView } from '@xneog/dsh-tools/presentation'
export type {
...
export { AbstractApiClient } from '@xneog/dsh-host-apiproxy/client'
export type { IApiClient } from '@xneog/dsh-host-apiproxy/client'
export type { SessionId, SessionEvent } from '@xneog/dsh-session/types'
export type { MessageId } from '@xneog/dsh-llm/brand'
export type { ContentBlock, StreamChunk } from '@xneog/dsh-llm/types'

/** Successful value returned by the connection-generation host handshake. */
export type HostDescription = import('@xneog/dsh-host-apiproxy/api').ResponseValue<'host.describe'>

import type { RpcResponse, RpcResult } from '@xneog/dsh-host-apiproxy/api'
