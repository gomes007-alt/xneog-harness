...
import {
  ...
  createUserMessage,
  isTokenDelta,
} from '@xneog/dsh-llm/message'
import { CallId } from '@xneog/dsh-llm/brand'
import type {
  AssistantMessage,
  ContentBlock,
  MessageSource,
...
import type { AttachmentIdType, ImageAttachmentRef } from '@xneog/dsh-attachment'
import type {
  SessionEvent,
  SessionId,
  TodoItem,
} from '@xneog/dsh-session/types'
// Type-only: the brand constructor is host-side; the fixture casts at its
// wire-fabrication boundary (the schema layer's one-cast-point posture).
import type { CommandId } from '@xneog/dsh-commands/brand'
import type { CommandDescriptor, CommandExecution, CommandResult } from '@xneog/dsh-commands/types'
import { deriveEventMessage, foldSurface } from '@xneog/dsh-session/surface'
import type {
  ApiProxy, ClientRequest, ClientResponse, HistoryEntry, HostFrame, MuxFrame, RpcReceipt,
  ModelProviderGroup, ModelSelection, RpcRequest, RpcResponse, RpcResult, ServerRequest, ServerResponse, SessionSummary,
  ToolCallView, ToolEventView, ToolResultView, WorkspaceId, WorkspaceView,
} from './api.ts'
import type { RequestPayload, ResponseValue, RpcMethodMap } from '@xneog/dsh-host-apiproxy/api'
...
const WEB_SEARCH_RESULT: Omit<Extract<ToolResultView, { card: 'web'; kind: 'search' }>, 'card' | 'kind'> = {
  answer: 'xneog is a plugin-based agent harness on vendored Cordis where **every capability is a plugin**.',
  sources: [
    {
      url: 'https://github.com/deepseek-ai/deepseek-harness',
      title: 'xneog — plugin-based agent harness',
