/**
 * Package-owned invariant companion for `@xneog/dsh-session-title-all-prompts-llm`.
 * @module @xneog/dsh-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-title-all-prompts-llm'
