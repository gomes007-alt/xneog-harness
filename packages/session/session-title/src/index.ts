 ...
 * @module @xneog/dsh-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@xneog/cordis'
import z from '@xneog/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@xneog/dsh-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@xneog/dsh-llm'
import type { GenerateOptions } from '@xneog/dsh-llm'
import type {
  Session,
  SessionEvent,
