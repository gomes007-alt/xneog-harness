 ...
 * @module @xneog/dsh-session-persistence
 */

import { Context, Service } from '@xneog/cordis'
import { SessionPreparation } from '@xneog/dsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@xneog/dsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@xneog/dsh-session'
