/**
 * Package-owned invariant companion for `@xneog/dsh-session-persistence`.
 * @module @xneog/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-persistence'
