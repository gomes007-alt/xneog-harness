/**
 * Package-owned invariant companion for `@xneog/dsh-session-title-first-prompt-llm`.
 * @module @xneog/dsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-title-first-prompt-llm'
