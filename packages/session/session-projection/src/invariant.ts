/**
 * Package-owned invariant companion for `@xneog/dsh-session-projection`.
 * @module @xneog/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-projection'
