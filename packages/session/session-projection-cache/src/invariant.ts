/**
 * Package-owned invariant companion for `@xneog/dsh-session-projection-cache`.
 * @module @xneog/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-projection-cache'
