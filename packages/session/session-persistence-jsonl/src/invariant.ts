/**
 * Package-owned invariant companion for `@xneog/dsh-session-persistence-jsonl`.
 * @module @xneog/dsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-persistence-jsonl'
