/**
 * Package-owned invariant companion for `@xneog/dsh-session-persistence-sqlite`.
 * @module @xneog/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-persistence-sqlite'
