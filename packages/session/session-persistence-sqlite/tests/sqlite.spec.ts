...
import type { Session, SessionEvent, SurfaceEvent, SurfaceEventType } from '@xneog/dsh-session'
import SqliteSessionPersistence, { SCHEMA_VERSION } from '@xneog/dsh-session-persistence-sqlite'
import {
  openDatabase,
  rowToEvent,
  rowToMeta,
