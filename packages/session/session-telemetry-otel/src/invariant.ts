/**
 * Package-owned invariant companion for `@xneog/dsh-session-telemetry-otel`.
 * @module @xneog/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-telemetry-otel'
