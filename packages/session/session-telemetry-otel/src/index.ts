/**
 * OpenTelemetry Service Provider for the xneog telemetry capability.
 *
 ...
 *
 * @module @xneog/dsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@xneog/schemastery'
import type { Context } from '@xneog/cordis'
import type {} from '@xneog/dsh-command-feedback'
import {
...
} from '@xneog/dsh-session-telemetry'
import { APP_IDENTITY } from '@xneog/dsh-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@xneog/dsh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@xneog/dsh-session-telemetry-otel/ops', version)
