/**
 * Package-owned invariant companion for `@xneog/dsh-session-title-llm`.
 * @module @xneog/dsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-title-llm'
