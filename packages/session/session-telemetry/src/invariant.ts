/**
 * Package-owned invariant companion for `@xneog/dsh-session-telemetry`.
 * @module @xneog/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-telemetry'
