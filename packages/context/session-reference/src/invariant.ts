/**
 * Package-owned invariant companion for `@xneog/dsh-session-reference`.
 * @module @xneog/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-session-reference'
