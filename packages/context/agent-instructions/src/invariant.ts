/**
 * Package-owned invariant companion for `@xneog/dsh-agent-instructions`.
 * @module @xneog/dsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-agent-instructions'
