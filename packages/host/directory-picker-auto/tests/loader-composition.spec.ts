...
import HttpServer from '@xneog/dsh-host-webserver'
import type { DirectoryPicker } from '@xneog/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@xneog/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@xneog/dsh-host-directory-picker-native'
...
const AUTO = '@xneog/dsh-host-directory-picker-auto'
const NATIVE = '@xneog/dsh-host-directory-picker-native'
const BROWSE = '@xneog/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@xneog/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@xneog/dsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['@xneog/dsh-host-webserver', HttpServer],
