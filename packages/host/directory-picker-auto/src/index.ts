 ...
 * @module @xneog/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@xneog/dsh-host-directory-picker-native',
  browse: '@xneog/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@xneog/dsh-client-ui-directory-picker-native',
  browse: '@xneog/dsh-client-ui-directory-picker-browse',
}
