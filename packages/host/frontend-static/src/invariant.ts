/**
 * Package-owned invariant companion for `@xneog/dsh-host-frontend-static`.
 * @module @xneog/dsh-host-frontend-static/invariant
 */

import type { Context } from '@xneog/cordis'
import type { InvariantInstaller } from '@xneog/dsh-invariants'

const PACKAGE_NAME = '@xneog/dsh-host-frontend-static'
