...
import type { ApprovalRequestId } from '@xneog/dsh-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@xneog/dsh-host-apiproxy/api'
import type { RpcId } from '@xneog/dsh-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@xneog/dsh-host-apiproxy/api/rpc'
