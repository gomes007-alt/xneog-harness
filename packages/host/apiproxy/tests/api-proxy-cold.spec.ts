...
import { TypertLookupFailure } from '@xneog/dsh-typert-protocol'
import TypertRegistry from '@xneog/dsh-typert-registry'
import { createUserMessage, MessageId } from '@xneog/dsh-llm'
import type { Agent } from '@xneog/dsh-agent'
import UserQuestionService from '@xneog/dsh-user-questions'
import type { SessionEvent, SessionHeader, SessionId } from '@xneog/dsh-session'
import {
  PersistenceCoordinator,
  SessionPersistenceRevision,
  type PersistenceBackend,
  type StoredPrefix,
} from '@xneog/dsh-session-persistence'
import type { RpcRequest } from '@xneog/dsh-host-apiproxy/api/rpc'
...
describe('Remote Agent and Session lookup policy', () => {
  it('deduplicates a cold resume across Agent and Session parameters', async () => {
    ...
    const resumedSession = { id: sessionId, header: meta, events: [] } as unknown as import('@xneog/dsh-session').Session
