...
import type { AskUserQuestionItem } from '@xneog/dsh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@xneog/dsh-user-approval/types'
import type { Message } from '@xneog/dsh-llm/types'
import type { MessageId } from '@xneog/dsh-llm/brand'
import type { CallId } from '@xneog/dsh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@xneog/dsh-session/types'
import type { ToolCallView, ToolResultView } from '@xneog/dsh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@xneog/dsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
