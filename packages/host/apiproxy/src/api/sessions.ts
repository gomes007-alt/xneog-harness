...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@xneog/dsh-attachment'
import type { ContentBlock } from '@xneog/dsh-llm/types'
import type { SessionEvent, SessionId } from '@xneog/dsh-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@xneog/dsh-session-projection/types'
