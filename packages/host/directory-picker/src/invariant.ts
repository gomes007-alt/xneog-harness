/** Package-owned invariant companion for the directory-picker seam. @module @xneog/dsh-host-directory-picker/invariant */

import type { Context } from '@xneog/cordis'
import type { InvariantInstaller } from '@xneog/dsh-invariants'

const PACKAGE_NAME = '@xneog/dsh-host-directory-picker'
