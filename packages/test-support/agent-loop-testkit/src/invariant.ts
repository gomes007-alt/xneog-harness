/**
 * Package-owned invariant companion for `@xneog/dsh-agent-loop-testkit`.
 * @module @xneog/dsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-agent-loop-testkit'
