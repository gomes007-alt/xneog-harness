/**
 * Package-owned invariant companion for `@xneog/dsh-client-test-runtime`.
 * @module @xneog/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-client-test-runtime'
