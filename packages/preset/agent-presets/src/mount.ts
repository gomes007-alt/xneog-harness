 ...
 * @module @xneog/dsh-agent-presets/mount
 */
...
import type { EntryTree } from '@xneog/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@xneog/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@xneog/dsh-*` row would fail to import. The
