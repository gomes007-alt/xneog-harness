 ...
 * @module @xneog/dsh-agent-presets
 */

import { stat } from 'node:fs/promises'
import { Context, Service } from '@xneog/cordis'
import z from '@xneog/schemastery'
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@xneog/dsh-scope'
// Type-only: resolves the `agent/created` lifecycle event this service watches.
import type {} from '@xneog/dsh-agent'
import { settingsNamespace, type SettingsScope, type default as SettingsService } from '@xneog/dsh-settings'
