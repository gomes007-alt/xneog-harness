/**
 * Package-owned invariant companion for `@xneog/dsh-agent-presets`.
 * @module @xneog/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@xneog/dsh-agent-presets'

const PACKAGE_NAME = '@xneog/dsh-agent-presets'
