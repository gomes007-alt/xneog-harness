/**
 * Package-owned invariant companion for `@xneog/dsh-settings-file`.
 * @module @xneog/dsh-settings-file/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@xneog/dsh-settings`.
 */
