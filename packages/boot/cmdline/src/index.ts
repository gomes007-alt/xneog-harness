/**
 * @xneog/dsh-cmdline — the command line a dsh launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `xneog --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
