 ...
 *
 * @module @xneog/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@xneog/dsh-shell'
import type { SandboxMode } from '@xneog/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@xneog/dsh-sandbox'
 ...
 * rendering story, owned by `@xneog/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@xneog/dsh-shell'
