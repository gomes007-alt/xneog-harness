 ...
 *
 * @module @xneog/dsh-shell-env
 */

import { Service, type Context } from '@xneog/cordis'
import z from '@xneog/schemastery'
import { DSH_ENV_PREFIX } from '@xneog/dsh-shell'
import type { DshEnvironment, DshEnvironmentKey } from '@xneog/dsh-shell'
import { DSH_HOME_ENV, resolveDshHome } from '@xneog/dsh-home-paths'
