 ...
 * `@xneog/dsh-pwsh-local`) backs `ctx.shell`; the tool contract is
 ...
 * exit-status parse from `@xneog/dsh-shell`.
 *
 * @module @xneog/dsh-tool-pwsh
 */

import { isAbsolute, resolve as resolvePath } from 'node:path'
import type { Context } from '@xneog/cordis'
import z from '@xneog/schemastery'
import { defineTool, TOOL_ABORTED } from '@xneog/dsh-tools'
import type { GenericCallView, TerminalCallView, ToolExecution, ToolResult, ToolResultView } from '@xneog/dsh-tools'
...
import type { SandboxExecutionPolicy, SandboxMode } from '@xneog/dsh-sandbox'
import { ESCALATION_TARGETS, approveEscalation, validateEscalationArgs } from '@xneog/dsh-sandbox'
import type { SandboxPolicyService } from '@xneog/dsh-sandbox-policy'
import type { ShellRunResult } from '@xneog/dsh-shell'
import { parseExitStatus } from '@xneog/dsh-shell'
import { processOutcome } from './background.ts'
import { renderPwshProcessRead, renderPwshResult } from './render.ts'
import type { RenderablePwshResult } from './render.ts'

declare module '@xneog/dsh-jobs' {
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: PwshToolArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) {
          throw new Error('background jobs unavailable: load @xneog/dsh-jobs and @xneog/dsh-tool-jobs')
        }
