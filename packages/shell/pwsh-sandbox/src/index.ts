 ...
 * `@xneog/dsh-bash-sandbox`. It wraps the exact local pwsh argv through
...
import { SandboxUnavailableError } from '@xneog/dsh-sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
