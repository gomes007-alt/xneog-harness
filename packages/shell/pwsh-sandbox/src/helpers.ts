 ...
 * mirror of `@xneog/dsh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @xneog/dsh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@xneog/dsh-shell'
import type { RunnerFailureRule } from '@xneog/dsh-sandbox'
