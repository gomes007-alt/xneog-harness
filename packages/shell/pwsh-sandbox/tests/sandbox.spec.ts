...
import type { ConfinedArgv, RunnerFailureRule, SandboxExecutionPolicy, SandboxPolicy } from '@xneog/dsh-sandbox'
import { resolvePwshPath } from '@xneog/dsh-pwsh-local'
