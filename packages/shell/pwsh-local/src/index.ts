...
import { SHELL_SETTINGS_NAMESPACE, ShellExecutor } from '@xneog/dsh-shell'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellProcessRead, ShellRunResult, CollectedOutput } from '@xneog/dsh-shell'
import type { SubprocessCollect, SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@xneog/dsh-subprocess'
import { installSettingsSection } from '@xneog/dsh-settings'
import { clampTimeout, deadline, MAX_TIMER_DELAY_MS, timeoutOf } from '@xneog/dsh-timeout'
/* jscpd:ignore-end */
...
export class PwshLocalExecutor extends ShellExecutor {
   ...
   * pwsh-confining consumer is `@xneog/dsh-pwsh-sandbox`.
