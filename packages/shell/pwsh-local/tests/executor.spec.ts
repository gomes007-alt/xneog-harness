/**
 * Real-process tests for `@xneog/dsh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@xneog/dsh-pwsh-local'
import LocalSubprocessRuntime from '@xneog/dsh-subprocess-local'
import SubprocessRuntime from '@xneog/dsh-subprocess'
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@xneog/dsh-subprocess'
import { MAX_TIMER_DELAY_MS } from '@xneog/dsh-timeout'
import type { ShellProcess } from '@xneog/dsh-shell'
