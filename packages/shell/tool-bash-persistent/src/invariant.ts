/**
 * Package-owned invariant companion for `@xneog/dsh-tool-bash-persistent`.
 * @module @xneog/dsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-tool-bash-persistent'
