/** Package-owned durable retry-event invariants. @module @xneog/dsh-llm-retry/invariant */

import type { Context } from '@xneog/cordis'
import type { Session, SessionEvent } from '@xneog/dsh-session'
import type { LlmFailure } from '@xneog/dsh-llm'
...
const PACKAGE_NAME = '@xneog/dsh-llm-retry'
