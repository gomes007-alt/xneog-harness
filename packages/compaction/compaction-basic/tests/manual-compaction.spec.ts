...
import { CommandId } from '@xneog/dsh-commands/brand'
...
import * as CompactionInvariant from '@xneog/dsh-compaction/invariant'
import * as CompactionBasicInvariant from '@xneog/dsh-compaction-basic/invariant'
import { BasicCompactionEngine } from '@xneog/dsh-compaction-basic'
import { CompactionId, isCompactCheckpointSource, ManualCompactionError } from '@xneog/dsh-compaction'
...
import SessionStore, { Session, SessionId, type SessionEvent } from '@xneog/dsh-session'
...
import type {
  SummarizationInput,
  SummaryResult,
} from '@xneog/dsh-compaction-basic/src/summarizer.ts'
