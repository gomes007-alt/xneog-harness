...
import { AttachmentId } from '@xneog/dsh-attachment'
import BasicCompactionEngine from '@xneog/dsh-compaction-basic'
import type { BasicCompactionConfig } from '@xneog/dsh-compaction-basic'
import { selectCompactableRange } from '@xneog/dsh-compaction-basic/src/region.ts'
import type { SummarizationInput, SummaryResult } from '@xneog/dsh-compaction-basic/src/summarizer.ts'
import { CompactionId, toolPairingBalancedAfter, toolPairingBalancedBefore } from '@xneog/dsh-compaction'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
} from '@xneog/dsh-compaction-basic/src/config.ts'
import type { CompactionResult } from '@xneog/dsh-compaction'
import LlmRuntime, { createUserMessage, CallId, CONTEXT_WINDOW_EXCEEDED_CODE, createToolResultMessage, LlmAdapter , createMessage } from '@xneog/dsh-llm'
import type {
  ContentBlock,
  GenerateOptions,
  LlmFailure,
...
import SessionStore, { Session, SessionId } from '@xneog/dsh-session'
import TokenMeter from '@xneog/dsh-token-meter'
import { agentEvents, type Agent, type RequestErrorAction } from '@xneog/dsh-agent'
import ToolResultPruner from '@xneog/dsh-compaction-tool-result-pruner'
