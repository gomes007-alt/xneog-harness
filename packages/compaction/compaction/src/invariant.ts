/** Package-owned compaction log-stream invariants. @module @xneog/dsh-compaction/invariant */

import type { Context } from '@xneog/cordis'
import { isReplacementSurfaceEvent } from '@xneog/dsh-session'
...
const PACKAGE_NAME = '@xneog/dsh-compaction'
