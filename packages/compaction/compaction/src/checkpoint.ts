 ...
 *
 * The seam itself lives in `@xneog/dsh-compaction`, which re-exports these
 ...
 *
 * @module @xneog/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@xneog/dsh-llm/message'
