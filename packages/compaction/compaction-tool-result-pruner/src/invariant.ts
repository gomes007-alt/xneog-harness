/**
 * Package-owned invariant companion for `@xneog/dsh-compaction-tool-result-pruner`.
 * @module @xneog/dsh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-compaction-tool-result-pruner'
