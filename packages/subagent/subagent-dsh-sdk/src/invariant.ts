/**
 * Package-owned invariant companion for `@xneog/dsh-subagent-dsh-sdk`.
 * @module @xneog/dsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-subagent-dsh-sdk'
