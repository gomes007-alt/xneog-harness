/**
 * Fresh-process SDK subagent client. Drives one child xneog
 * runtime over stdio JSON-RPC through `@xneog/dsh-sdk-client` and owns
 * cancellation and quiescent disposal. Structure mirrors the ACP backend
 * (`@xneog/dsh-subagent-acp`): publish after the child handshake,
 ...
 *
 * @module @xneog/dsh-subagent-dsh-sdk/run
 */

import { randomUUID } from 'node:crypto'
import { DeepSeekHarness, type HarnessNotification } from '@xneog/dsh-sdk-client'
import type { ContentBlock } from '@xneog/dsh-llm'
import { SessionId, type SessionEvent, type TurnEndReason } from '@xneog/dsh-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@xneog/dsh-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@xneog/dsh-subagent'
import { scrubbedParentEnv } from '@xneog/dsh-subprocess'
