...
import type { SessionProjectionRegistry } from '@xneog/dsh-session-projection'
import type { SessionProjectionCache } from '@xneog/dsh-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @xneog/dsh-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @xneog/dsh-session)',
