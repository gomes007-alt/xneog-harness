/**
 * Package-owned invariant companion for `@xneog/dsh-tool-subagent-report`.
 * @module @xneog/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-tool-subagent-report'
