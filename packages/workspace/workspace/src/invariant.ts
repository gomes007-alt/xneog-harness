/**
 * Package-owned invariant companion for `@xneog/dsh-workspace`.
 * @module @xneog/dsh-workspace/invariant
 */
...
import { WorkspaceId } from '@xneog/dsh-workspace'

const PACKAGE_NAME = '@xneog/dsh-workspace'
