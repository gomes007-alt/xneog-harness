 ...
 * @module @xneog/dsh-agent-spine-demo
 */

import type { Context } from '@xneog/cordis'
import Timer from '@xneog/cordis-plugin-timer'
import z from '@xneog/schemastery'
import LlmRuntime from '@xneog/dsh-llm'
import SessionStore from '@xneog/dsh-session'
import SessionTitleService, { type Config as SessionTitleConfig } from '@xneog/dsh-session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@xneog/dsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@xneog/dsh-tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@xneog/dsh-skill'
import * as SkillFileSystem from '@xneog/dsh-skill-filesystem'
import AgentRegistry from '@xneog/dsh-agent'
import GoalService, { type Config as GoalDomainConfig } from '@xneog/dsh-goal'
import * as goalSession from '@xneog/dsh-goal-round-driver'
import * as toolGoal from '@xneog/dsh-tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@xneog/dsh-jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@xneog/dsh-invariants'
import * as sessionInvariant from '@xneog/dsh-session/invariant'
import * as agentInvariant from '@xneog/dsh-agent/invariant'
import * as scopeInvariant from '@xneog/dsh-scope/invariant'
import * as agentLoopInvariant from '@xneog/dsh-agent-loop/invariant'
import * as toolBash from '@xneog/dsh-tool-bash'
import * as bashEnv from '@xneog/dsh-shell-env'
import * as workspaceContext from '@xneog/dsh-agent-instructions'
import * as toolSkill from '@xneog/dsh-tool-skill'
import * as toolJobs from '@xneog/dsh-tool-jobs'
import AgentLoop, { type Config as AgentLoopConfig } from '@xneog/dsh-agent-loop'
import * as llmRetry from '@xneog/dsh-llm-retry'
import { resolveDshHome } from '@xneog/dsh-home-paths'
