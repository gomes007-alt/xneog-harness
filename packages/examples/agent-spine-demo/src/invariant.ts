/**
 * Package-owned invariant companion for `@xneog/dsh-agent-spine-demo`.
 * @module @xneog/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-agent-spine-demo'
