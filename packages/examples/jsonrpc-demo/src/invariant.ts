/**
 * Package-owned invariant companion for `@xneog/dsh-sdk-jsonrpc-demo`.
 * @module @xneog/dsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-sdk-jsonrpc-demo'
