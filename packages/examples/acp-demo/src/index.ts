 ...
 * ({@link @xneog/dsh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @xneog/dsh-acp} bridge. The app owns those plugins through one
 ...
 * @module @xneog/dsh-acp-demo
 */

import type { Context } from '@xneog/cordis'
import { join } from 'node:path'
import z from '@xneog/schemastery'
import * as acp from '@xneog/dsh-acp'
import * as agentCore from '@xneog/dsh-agent-spine-demo'
...
} from '@xneog/dsh-session-persistence-jsonl'
