/** Package-owned scoped-dispatch invariants. @module @xneog/dsh-scope/invariant */

import type { Context } from '@xneog/cordis'
import type { InvariantInstaller } from '@xneog/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@xneog/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@xneog/dsh-scope'
