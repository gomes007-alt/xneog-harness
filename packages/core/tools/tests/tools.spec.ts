...
import { createUserMessage, CallId, HarnessError, type ContentBlock  } from '@xneog/dsh-llm'
import SystemPrompt from '@xneog/dsh-system-prompt'
import type { Agent } from '@xneog/dsh-agent'
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@xneog/dsh-user-approval'
import ToolRuntime, {
