...
import { Context, FiberState, getTraceable, Service, symbols } from '@xneog/cordis'
...
import type { TypertContext, TypertLookup } from '@xneog/dsh-typert-protocol'
 ...
 * (`@xneog/dsh-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@xneog/dsh-agent#Agent',
