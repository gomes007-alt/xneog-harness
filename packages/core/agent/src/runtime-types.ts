 ...
 * turn/step boundaries remain `@xneog/dsh-session` events.
 *
 * @module @xneog/dsh-agent
 */

import type { Context } from '@xneog/cordis'
import type { Scoped } from '@xneog/dsh-scope'
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@xneog/dsh-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@xneog/dsh-session'
export type { AgentCancelCause } from '@xneog/dsh-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@xneog/dsh-system-prompt'
declare module '@xneog/dsh-system-prompt' {
...
declare module '@xneog/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@xneog/dsh-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
