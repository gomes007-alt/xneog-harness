 ...
 * @module @xneog/dsh-agent-loop/invariant
 */

import type { Context } from '@xneog/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@xneog/dsh-llm'
import type { InvariantFailure, InvariantInstaller } from '@xneog/dsh-invariants'
import { foldRequestHeader } from '@xneog/dsh-session'

const PACKAGE_NAME = '@xneog/dsh-agent-loop'
