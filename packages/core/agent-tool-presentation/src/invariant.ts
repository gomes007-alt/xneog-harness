/**
 * Package-owned invariant companion for `@xneog/dsh-agent-tool-presentation`.
 * @module @xneog/dsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-agent-tool-presentation'
