 ...
 *
 * @module @xneog/dsh-session
 */

import { Context, Service } from '@xneog/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@xneog/dsh-llm'
import { scopeOf, scopeTarget } from '@xneog/dsh-scope'
import type { Scoped } from '@xneog/dsh-scope'
import type { Message } from '@xneog/dsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@xneog/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@xneog/dsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@xneog/dsh-session#Session',
        wireTypeSymbol: '@xneog/dsh-session/types#SessionId',
