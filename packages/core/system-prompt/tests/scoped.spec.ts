...
import { createScope, scopeOf } from '@xneog/dsh-scope'
import type { Scope, ScopeKey } from '@xneog/dsh-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@xneog/dsh-system-prompt'
import type { Config, PromptAssembly } from '@xneog/dsh-system-prompt'
