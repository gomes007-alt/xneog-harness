/**
 * Shared wire protocol for the xneog SDK runtime: the
 ...
 * (`@xneog/dsh-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@xneog/dsh-sdk-client`, the Python SDK) drive it.
 *
 * @module @xneog/dsh-sdk-protocol
 */
