/**
 * Package-owned invariant companion for `@xneog/dsh-sdk-jsonrpc-server`.
 * @module @xneog/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-sdk-jsonrpc-server'
