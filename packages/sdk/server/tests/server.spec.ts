...
import AgentRegistry, { type Agent, type AgentHandle } from '@xneog/dsh-agent'
...
import SubagentRuntime, { type SubagentResult, type SubagentRunEndInfo } from '@xneog/dsh-subagent'
import type { JsonRpcTransportPeer } from '@xneog/dsh-sdk-protocol'
  ...
  it('rejects unknown JSON-RPC runtime methods', async () => {
    ...
    try {
      ...
      await expect(server.handleRequest('does/not/exist', {}))
        .rejects
        .toThrow('unknown xneog SDK runtime method: does/not/exist')
