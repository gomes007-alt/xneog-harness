/**
 * Package-owned invariant companion for `@xneog/dsh-anonymous-user-id`.
 * @module @xneog/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-anonymous-user-id'
