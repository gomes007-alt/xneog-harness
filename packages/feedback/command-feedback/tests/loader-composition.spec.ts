...
import * as CommandFeedback from '@xneog/dsh-command-feedback'
...
describe('/feedback real Loader composition through cordis.yml', () => {
  it('boots cordis.yml and records feedback without model-visible output', async () => {
    ...
    await writeFile(configPath, [
      ...
      "- name: '@xneog/dsh-commands'",
      "- name: '@xneog/dsh-command-feedback'",
      '',
    ].join('\n'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@xneog/dsh-commands', CommandRuntime],
      ['@xneog/dsh-command-feedback', CommandFeedback],
    ])
