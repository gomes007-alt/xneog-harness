...
import SessionStore, { foldSurface, Session, SessionId } from '@xneog/dsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@xneog/dsh-session-telemetry'
...
vi.mock('@xneog/dsh-anonymous-user-id', () => ({
...
describe('@xneog/dsh-command-feedback registration', () => {
