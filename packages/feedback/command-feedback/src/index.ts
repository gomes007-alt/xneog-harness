 ...
 * @module @xneog/dsh-command-feedback
 */

import type { Context } from '@xneog/cordis'
import type { CommandInvocation, CommandResult } from '@xneog/dsh-commands'
import type { SessionTelemetryBackend, SessionTelemetrySharingStatus } from '@xneog/dsh-session-telemetry'
