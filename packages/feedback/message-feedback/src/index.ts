 ...
 * @module @xneog/dsh-message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@xneog/cordis'
import s from '@xneog/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@xneog/dsh-session/surface'
import type { SessionHeader, SessionId } from '@xneog/dsh-session/types'
import type { SessionInspection } from '@xneog/dsh-session-persistence'
import type { KvTable } from '@xneog/dsh-storage-domain'
import { TypertRemoteService, Remote } from '@xneog/dsh-typert-protocol'
