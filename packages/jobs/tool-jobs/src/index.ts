 ...
 * @module @xneog/dsh-tool-jobs
 */

import type { Context } from '@xneog/cordis'
import z from '@xneog/schemastery'
import { boundContextSummary, createUserMessage, type ContentBlock } from '@xneog/dsh-llm'
import { TextRetainer } from '@xneog/dsh-output-retention'
import { defineTool } from '@xneog/dsh-tools'
import type { GenericCallView, ToolDefinition, ToolExecution } from '@xneog/dsh-tools'
