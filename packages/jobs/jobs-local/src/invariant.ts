/**
 * Package-owned invariant companion for `@xneog/dsh-jobs-local`.
 * @module @xneog/dsh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-jobs-local'
...
/**
 * No runtime invariant: `@xneog/dsh-jobs/invariant` owns per-snapshot identity, status,
