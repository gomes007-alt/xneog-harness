 ...
 * @module @xneog/dsh-cordis-host-runner/guard
 */

import { Context } from '@xneog/cordis'
import type { Plugin } from '@xneog/cordis'
import { scopeOf } from '@xneog/dsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@xneog/dsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@xneog/dsh-cordis-client-runner`, whose CTX_VERBS names this one its
