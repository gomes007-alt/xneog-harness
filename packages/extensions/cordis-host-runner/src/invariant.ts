/**
 * Package-owned invariant companion for `@xneog/dsh-cordis-host-runner`.
 * @module @xneog/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-cordis-host-runner'
