/**
 * Package-owned invariant companion for `@xneog/dsh-cordis-client-runner`.
 * @module @xneog/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-cordis-client-runner'
