 ...
 *
 * @module @xneog/dsh-tool-fs-search/grep
 */

import type { Context } from '@xneog/cordis'
import { defineTool } from '@xneog/dsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@xneog/dsh-tools'
import type { RetainedItems } from '@xneog/dsh-output-retention'
import type { SpillRef } from '@xneog/dsh-spill'
