 ...
 * model-facing render consumes ({@link module:@xneog/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @xneog/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@xneog/dsh-tool-fs-search/grep} `formatGrepMatches`), so
