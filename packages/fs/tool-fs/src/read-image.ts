 ...
 * @module @xneog/dsh-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@xneog/cordis'
import { AttachmentError, AttachmentId } from '@xneog/dsh-attachment'
import type { ImageAttachmentRef, ImageMediaType } from '@xneog/dsh-attachment'
import type { ContentBlock } from '@xneog/dsh-llm'
import { defineTool } from '@xneog/dsh-tools'
import type { GenericCallView, ToolExecution } from '@xneog/dsh-tools'
import type {} from '@xneog/dsh-fs'
