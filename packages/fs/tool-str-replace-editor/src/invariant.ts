/**
 * Package-owned invariant companion for `@xneog/dsh-tool-str-replace-editor`.
 * @module @xneog/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-tool-str-replace-editor'
