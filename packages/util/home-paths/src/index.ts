/**
 * Shared filesystem path helpers for xneog user data.
 *
 * @module @xneog/dsh-home-paths
 */
...
/** Directory name for the default xneog home under the OS home. */
export const DSH_HOME_DIR_NAME = '.xneog-harness'

/** Stable user-facing display form for the default xneog home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default xneog home. */
...
/**
 * Resolve the default xneog home using Node's platform path rules.
...
/**
 * Resolve the single-root xneog home.
 *
...
/**
 * Join path segments onto the resolved xneog home.
