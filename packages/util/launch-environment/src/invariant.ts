/**
 * Package-owned invariant companion for `@xneog/dsh-launch-environment`.
 * @module @xneog/dsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-launch-environment'
