/**
 * Package-owned invariant companion for `@xneog/dsh-output-retention`.
 * @module @xneog/dsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-output-retention'
