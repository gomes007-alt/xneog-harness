 ...
 * @module @xneog/dsh-credentials-local
 */
...
import { withFileLock, writeFileAtomic } from '@xneog/dsh-atomic-write'
import { canonicalizeWatchPath, resolveDshHome } from '@xneog/dsh-home-paths'
import { launchEnvironmentOf } from '@xneog/dsh-launch-environment'
import { CredentialProvider, credentialRef } from '@xneog/dsh-credentials'
import type { CredentialInfo, CredentialRef, ResolvedCredential } from '@xneog/dsh-credentials'
import type { LaunchEnvironmentEntry } from '@xneog/dsh-launch-environment'
