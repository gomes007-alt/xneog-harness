/**
 * Package-owned invariant companion for `@xneog/dsh-credentials-local`.
 * @module @xneog/dsh-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-credentials-local'
