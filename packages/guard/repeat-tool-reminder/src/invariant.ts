/**
 * Package-owned invariant companion for `@xneog/dsh-repeat-tool-reminder`.
 * @module @xneog/dsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-repeat-tool-reminder'
