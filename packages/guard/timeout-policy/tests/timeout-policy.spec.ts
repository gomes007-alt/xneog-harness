/**
 * Unit + real-load-path coverage for @xneog/dsh-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@xneog/dsh-llm'
import SystemPrompt from '@xneog/dsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@xneog/dsh-tools'
import * as timeoutPolicy from '@xneog/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@xneog/dsh-tool-call-timeout-policy'
