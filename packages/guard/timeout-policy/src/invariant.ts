/**
 * Package-owned invariant companion for `@xneog/dsh-tool-call-timeout-policy`.
 * @module @xneog/dsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-tool-call-timeout-policy'
