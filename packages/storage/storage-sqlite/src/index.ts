 ...
 * @module @xneog/dsh-storage-sqlite
 */

import type { Context } from '@xneog/cordis'
import z from '@xneog/schemastery'
import type { DatabaseSync } from 'node:sqlite'
import { StorageError, UNIT_NAME_RE, storageBackendServiceKey } from '@xneog/dsh-storage'
import type { KvFacet, KvUnit, KvUnitDescriptor, StorageBackend } from '@xneog/dsh-storage'
