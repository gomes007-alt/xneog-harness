/**
 * Package-owned invariant companion for `@xneog/dsh-storage-domain`: every
 ...
 * @module @xneog/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@xneog/dsh-storage-domain'
