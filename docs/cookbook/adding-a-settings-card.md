...
import type {} from '@xneog/dsh-client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@xneog/dsh-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@xneog/dsh-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
