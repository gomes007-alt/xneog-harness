import { Context, Service, type Plugin } from '@xneog/cordis'
import type { Dict } from '@xneog/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@xneog/cordis-plugin-loader'
import type { Include } from '@xneog/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@xneog/cordis-plugin-timer'
