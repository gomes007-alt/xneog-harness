...
function workspaceFixture(options: {
  ...
  writeJson(join(shared, 'package.json'), { name: '@xneog/dsh-shared' })
  writeJson(join(shared, 'tsconfig.json'), {
    extends: '../../../tsconfig.base.json',
    references: [],
  })
  writeJson(join(split, 'package.json'), { name: '@xneog/dsh-split' })
...
describe('Project Reference compiler faces', () => {
  ...
  it('uses the referencing project face throughout the reachable graph', () => {
    ...
    writeJson(join(hostConsumer, 'package.json'), { name: '@xneog/dsh-host-consumer' })
    ...
    writeJson(join(clientConsumer, 'package.json'), { name: '@xneog/dsh-client-consumer' })
