...
class ScopedEventGenerator {
  ...
  render(): string {
    ...
    return [
      ...
      ' *',
      ' * @module @xneog/dsh-scope/scoped-events.generated',
      ' */',
      '',
...
/** Return whether an Events interface is inside declare module '@xneog/cordis'. */
function isCordisModuleInterface(node: ts.InterfaceDeclaration): boolean {
  ...
  return ts.isModuleBlock(block)
    ...
    && declaration.name.text === '@xneog/cordis'
}
