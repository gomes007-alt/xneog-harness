...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@xneog/dsh-typert-generator'
import type { CordisCatalogPolicy } from '@xneog/dsh-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@xneog/cordis'`
 ...
 * scan reads EVERY `declare module '@xneog/cordis'` Events merge under
