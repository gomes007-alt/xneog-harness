...
import type { CordisCatalogModel, ServiceMethodEntry } from '@xneog/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@xneog/dsh-tool-cordis/api-catalog', '@xneog/dsh-cordis-client-runner/client/api-catalog')
