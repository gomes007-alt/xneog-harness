...
import type { WebBootEntry } from '@xneog/dsh-client-modules/client'
import { AppWebEntry } from '@xneog/dsh-client-web'
...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  { id: '@xneog/dsh-typert-registry', bundlePath: 'packages/typert/registry/lib/client.js', url: '/plugins/typert-registry.js', rev: 'fx', inject: [], immediately: true },
  { id: '@xneog/dsh-client-connection', bundlePath: 'packages/client/connection/lib/client.js', url: '/plugins/connection.js', rev: 'fx', inject: [], immediately: true },
  { id: '@xneog/dsh-api-gateway', bundlePath: 'packages/api/gateway/lib/client.js', url: '/plugins/api-gateway.js', rev: 'fx', inject: ['@xneog/dsh-typert-registry', '@xneog/dsh-client-connection'], immediately: true },
  { id: '@xneog/dsh-api-remotes', bundlePath: 'packages/api/remotes/lib/client.js', url: '/plugins/api-remotes.js', rev: 'fx', inject: ['@xneog/dsh-api-gateway'], immediately: true },
  ...
  { id: '@xneog/dsh-client-ui-settings', bundlePath: 'packages/client/ui-settings/lib/client.js', url: '/plugins/ui-settings.js', rev: 'fx', inject: ['@xneog/dsh-client-connection', '@xneog/dsh-client-runtime', '@xneog/dsh-api-remotes'], immediately: true },
  { id: '@xneog/dsh-client-runtime', bundlePath: 'packages/client/runtime/lib/client.js', url: '/plugins/runtime.js', rev: 'fx', inject: ['@xneog/dsh-client-connection', '@xneog/dsh-typert-registry', '@xneog/dsh-api-gateway'], immediately: true },
  { id: '@xneog/dsh-client-ui-theme', bundlePath: 'packages/client/ui-theme/lib/client.js', url: '/plugins/ui-theme.js', rev: 'fx', inject: ['@xneog/dsh-client-connection', '@xneog/dsh-client-runtime', '@xneog/dsh-client-locale', '@xneog/dsh-client-ui-settings', '@xneog/dsh-api-remotes'], immediately: true },
  { id: '@xneog/dsh-client-locale', bundlePath: 'packages/client/locale/lib/client.js', url: '/plugins/locale.js', rev: 'fx', inject: ['@xneog/dsh-client-connection', '@xneog/dsh-client-runtime', '@xneog/dsh-client-ui-settings', '@xneog/dsh-api-remotes'], immediately: true },
  { id: '@xneog/dsh-client-ui-layout', bundlePath: 'packages/client/ui-layout/lib/client.js', url: '/plugins/ui-layout.js', rev: 'fx', inject: ['@xneog/dsh-client-runtime'] },
  { id: '@xneog/dsh-client-ui-sidebar', bundlePath: 'packages/client/ui-sidebar/lib/client.js', url: '/plugins/ui-sidebar.js', rev: 'fx', inject: ['@xneog/dsh-client-ui-layout'] },
  { id: '@xneog/dsh-client-ui-conversation', bundlePath: 'packages/client/ui-conversation/lib/client.js', url: '/plugins/ui-conversation.js', rev: 'fx', inject: ['@xneog/dsh-client-ui-layout'] },
  { id: '@xneog/dsh-client-ui-tool', bundlePath: 'packages/client/ui-tool/lib/client.js', url: '/plugins/ui-tool.js', rev: 'fx', inject: ['@xneog/dsh-client-runtime', '@xneog/dsh-client-locale', '@xneog/dsh-client-ui-conversation'] },
  { id: '@xneog/dsh-client-ui-workflow-run', bundlePath: 'packages/client/ui-workflow-run/lib/client.js', url: '/plugins/ui-workflow-run.js', rev: 'fx', inject: ['@xneog/dsh-client-locale', '@xneog/dsh-client-runtime', '@xneog/dsh-client-ui-conversation'] },
  {
    id: '@xneog/dsh-client-ui-workspace',
    bundlePath: 'packages/client/ui-workspace/lib/client.js',
    url: '/plugins/ui-workspace.js',
    rev: 'fx',
    inject: [
      '@xneog/dsh-client-runtime',
      '@xneog/dsh-client-ui-conversation',
      '@xneog/dsh-client-ui-sidebar',
    ],
  },
  { id: '@xneog/dsh-session-log-export', bundlePath: 'packages/session-query/session-log-export/lib/client.js', url: '/plugins/session-log-download.js', rev: 'fx', inject: ['@xneog/dsh-client-ui-commands', '@xneog/dsh-client-ui-conversation'] },
  { id: '@xneog/dsh-client-ui-trajectory', bundlePath: 'packages/client/ui-trajectory/lib/client.js', url: '/plugins/ui-trajectory.js', rev: 'fx', inject: ['@xneog/dsh-client-ui-conversation'] },
]
