...
import { parseSessionLog } from '@xneog/dsh-llm-replay'
import type { SessionEvent, SessionId } from '@xneog/dsh-session'
import type {} from '@xneog/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@xneog/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@xneog/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@xneog/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@xneog/dsh-skill-filesystem"}\n',
