...
import { boot, healProfilesModuleFallback, loadOverlayPatches } from '@xneog/dsh-app-boot'
...
import type { PatchOptions } from '@xneog/cordis-plugin-include'
import { afterAll, beforeAll, describe, expect, it } from 'vitest'
import { settingsNamespace } from '@xneog/dsh-settings'
import { resolveSessionPreset, SETTINGS_NAMESPACE } from '@xneog/dsh-agent-presets'
import { applyChildComposition, childSessionMeta } from '@xneog/dsh-subagent'
import { CallId } from '@xneog/dsh-llm'
import type {} from '@xneog/dsh-compaction-basic'
...
import type {} from '@xneog/dsh-token-meter'
...
describe('product subagent rows in user presets', () => {
  ...
  beforeAll(async () => {
    ...
    productCtx = await bootWeb(settingsFile, [
      { insert: [
        { id: 'subagent-codex', name: '@xneog/dsh-subagent-codex' },
        { id: 'subagent-claude-code', name: '@xneog/dsh-subagent-claude-code' },
      ] },
      {
        id: 'agent-presets',
        config: {
