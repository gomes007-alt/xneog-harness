...
import { boot, loadOverlayPatches } from '@xneog/dsh-app-boot'
import SystemPrompt from '@xneog/dsh-system-prompt'
import ToolRuntime from '@xneog/dsh-tools'
import * as McpClient from '@xneog/dsh-mcp-client/src/index.ts'
...
describe('third-party memory MCP example overlays', () => {
  it.each(examples)('parses $file with the documented generic plugin fields', (contract) => {
    ...
    expect(row.name).toBe('@xneog/dsh-mcp-client')
