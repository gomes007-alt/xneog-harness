/**
 * `xneog-harness plugin --profile <name> <args...>` — profile plugin management as a
...
/**
 * Run one `xneog-harness plugin` invocation: init if needed, forward to pnpm, reconcile.
